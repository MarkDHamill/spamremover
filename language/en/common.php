...
<li>Afterward, reenable the board and verify it is working correctly and the spam has been removed.</li>
	...
	'ACP_SPAMREMOVER_SPAM_REMOVED'				=> 'Spam was removed. A total of %u posts, %u topics, %u users and %u private messages were removed. Additional posts are deleted when the first post of a topic is marked as spam, but aren’t included in this total.',
	'ACP_SPAMREMOVER_SPAM_REMOVED_PROGRESS'		=> 'Spam is being removed. A total of %u posts, %u topics, %u users and %u private messages have been removed so far. You are %s%% done.',
	'ACP_SPAMREMOVER_SPAM_SUMMARY'				=> 'Spam summary',
	'ACP_SPAMREMOVER_SPAM_TYPE'					=> 'Spam type',
	'ACP_SPAMREMOVER_TEST_MODE'					=> 'Test mode',
	'ACP_SPAMREMOVER_TEST_MODE_ERROR'			=> 'Since test mode is enabled, no actions were taken.',
