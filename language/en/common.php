...
<li>Afterward, reenable the board and verify it is working correctly and the spam has been removed.</li>
	...
	'ACP_SPAMREMOVER_INSTALL_REQUIREMENTS'		=> 'To communicate with Akismet, this extension requires the PHP extension sockets to be installed.',
